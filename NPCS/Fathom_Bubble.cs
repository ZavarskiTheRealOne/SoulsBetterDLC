...
namespace SoulsBetterDLC.NPCS
{
    ...
    public class Fathom_Bubble : ModNPC
    {
        ...
        public override void OnKill()
        {
            ...
            if (timerDead > 0)
            {
                ...
                Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.position, Vector2.Zero, ModContent.ProjectileType<Fathom_Cloud>(), 0, 0f, player.whoAmI);
            }
