...
namespace SoulsBetterDLC.NPCS.Bosses.ChampionofExaltation
{
    ...
    public class SilvaCrystal : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            {
                Main.EntitySpriteDraw(texture.Value, Projectile.oldPos[i] + new Vector2(Projectile.width, Projectile.height) / 2 - Main.screenPosition, null, new Color(200, 200, 200, 100) * (1f / (float)(i + 1)), Projectile.rotation, texture.Size() / 2, Projectile.scale, SpriteEffects.None, 0);
            }
