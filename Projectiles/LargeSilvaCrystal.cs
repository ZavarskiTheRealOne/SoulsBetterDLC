...
namespace SoulsBetterDLC.Projectiles
{
    ...
    public class LargeSilvaCrystal : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Asset<Texture2D> left = ModContent.Request<Texture2D>("SoulsBetterDLC/Projectiles/SilvaCrystalShard");
            Asset<Texture2D> right = ModContent.Request<Texture2D>("SoulsBetterDLC/Projectiles/SilvaCrystalShard2");
