	...
	public partial class DragonMinionHead : DragonMinion
	{
		...
		void HeadMovement()
		{
			...
			if (Projectile.alpha > 0)
			{
				...
				{
					int num13;
					num13 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.GreenTorch, 0f, 0f, 100, default(Color), 2f);
