...
namespace SoulsBetterDLC
{
    ...
    public class CalamityRecipesSystem : ModSystem
    {
        ...
        static void CalBagRecipes()
        {
            //fuck you Fargo for privating Grab Bag recipes >:(
        ...
        static void CalamityGroups()
        {
            ...
            //statigel head group
            RecipeGroup StatisHelmsGroup = new RecipeGroup(() => $"{Language.GetTextValue("LegacyMisc.37")} {"Statigel Headpiece"}",
            ...
            RecipeGroup.RegisterGroup("SoulsBetterDLC:AnyStatisHelms", StatisHelmsGroup);
            //statigel head group
