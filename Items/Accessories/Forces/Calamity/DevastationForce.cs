...
namespace SoulsBetterDLC.Items.Accessories.Forces.Calamity
{
    ...
    public class DevastationForce: BaseDLCForce
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.SetDefault("[i:SoulsBetterDLC/DaedalusEnchantment] While flying or gliding, damaging icicles fall down from your feet rapidly. Icicles deal 288 true damage and cannot be affected by boosts.\n" +
