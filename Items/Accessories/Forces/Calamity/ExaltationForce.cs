...
namespace SoulsBetterDLC.Items.Accessories.Forces.Calamity
{
    ...
    public class ExaltationForce: BaseDLCForce
    {
        ...
        {
            tooltips.Add(new TooltipLine(Mod, "SoulsBetterDLC:ExaltationForce", $"[i:SoulsBetterDLC/TarragonEnchantment] Picking up hearts grants reduced contact damage and a damaging aura when at full health\n" +
                ...
                $"[i:SoulsBetterDLC/SilvaEnchantment] You are encased in a silva crystal that boosts life regen and defense but decreases movement\n    Press " + CalamityKeybinds.SetBonusHotKey.TooltipHotkeyString() + " to shatter it and gain damage and spawn projectiles for the next 10 seconds\n" +
