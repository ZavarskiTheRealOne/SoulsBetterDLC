...
namespace SoulsBetterDLC.Items.Accessories.Forces.Calamity
{
    ...
    public class Devastation_Force: BaseDLCForce
    {
        ...
        public override void SafeAddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<Reaver_Enchantment>());
            recipe.AddIngredient(ModContent.ItemType<Hydrothermic_Enchantment>());
            recipe.AddIngredient(ModContent.ItemType<Bringer_Enchantment>(), 1);
